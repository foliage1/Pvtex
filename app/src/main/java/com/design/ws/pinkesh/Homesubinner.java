...
public class Homesubinner extends Activity implements IServiceRequest {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_closed_subinner);
        ...
        serviceRequest = Homesubinner.this;
        usersList = new ArrayList<User_closed_subinner>();


        recyclerView = (RecyclerView) findViewById(R.id.my_recycler_view);
        recyclerView.setHasFixedSize(true);
       recyclerView.addItemDecoration(new DividerItemDecoration(Homesubinner.this,
                DividerItemDecoration.VERTICAL));
        // use a linear layout manager
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        // create an Object for Adapter
        mAdapter = new UsersclosedAdaptersubinner(this, usersList);
    ...
    public void callService() {
        dialog = new ProgressDialog(Homesubinner.this);
                    ...
                    if (response.isSuccessful()) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                           ...
                           /* String pic = users.getString("product_img");
                            ...
                            User_closed_subinner user = new User_closed_subinner(firstName,count);
